...
from app.src.use_cases import ListProducts, FindProductById, CreateProduct, FindProductByStatus
...
def find_product_by_status_use_case() -> FindProductByStatus:
  return FindProductByStatus(get_product_repository())
